...
2026-09-26 更新：开发源码已改为静态获取 / Electron 隔离渲染 + Python 正文提取。当前行为见 [网页采集说明](crawl4ai.md)，体积和整进程内存见 [内存验证记录](crawl4ai-memory-validation.md)；以下独立 Chromium 的安装包、性能与发布数据是历史记录，不代表新路径的安装包验收。
